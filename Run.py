...
async def main():
    while True:
        try:
            ...
            # Следим за текущей 5-мин свечой
            start_time = time.time()
            candle_reached_threshold = False
            direction = None
            delta = 0

            while time.time() - start_time < 295:  # не дольше жизни одной свечи
            ...
            # Совершаем сделки, если есть лагающие монеты
            if lagging_coins:
